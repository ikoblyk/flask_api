...
class TestAuthors(BaseTestCase):
    ...
    def test_create_author(self):
        ...
        response = self.app.post('/api/authors/',data=json.dumps(author),content_type='application/json',headers= { 'Authorization': 'Bearer '+token })
        data = json.loads(response.data)
        self.assertEqual(404, response.status_code)
        self.assertFalse('author' in data)
    ...
    def test_upload_avatar(self):
        token = login()
        response = self.app.post('/api/authors/avatar/2',data=dict(avatar=(io.BytesIO(b'test'),'test_file.jpg')),
    ...
    def test_update_author(self):
        ...
        response = self.app.put('/api/authors/2',data=json.dumps(author),content_type='application/json',headers= { 'Authorization': 'Bearer '+token })
        self.assertEqual(404, response.status_code)
    ...
    def test_create_book(self):
        ...
        response = self.app.post('/api/books/',data=json.dumps(author),content_type='application/json',headers= { 'Authorization': 'Bearer '+token })
        data = json.loads(response.data)
    ...
    def test_create_book_no_authorization(self):
        ...
        response = self.app.post('/api/books/',data=json.dumps(author),content_type='application/json')
        data = json.loads(response.data)
    ...
    def test_get_books(self):
        ...
        data = json.loads(response.data)
        self.assertEqual(401, response.status_code)
        self.assertFalse('books' in data)
    ...
    def test_update_book(self):
        ...
        response = self.app.put('/api/books/2',data=json.dumps(author),content_type='application/json',headers= { 'Authorization': 'Bearer '+token })
